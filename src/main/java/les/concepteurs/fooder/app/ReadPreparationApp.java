...
public class ReadPreparationApp {
	...
	public static void main(String[] args) {
		...
		ServiceIngredient serviceIngredient = new ServiceIngredient(); Ingredient
		ingredient = serviceIngredient.findById(1); System.out.println(ingredient);
		System.out.println("Nom du rayon :" + ingredient.getRayon().getNomRayon());
		
		System.out.println("****************");
		System.out.println("****************");
		
		ServiceRecette serviceRecette = new ServiceRecette(); Recette recette =
		serviceRecette.findById(1); System.out.println(recette);
		...
		ServiceDenree serviceDenree = new ServiceDenree(); List<Denree> listeDenrees
		= serviceDenree.findByIdRecette(1);
		...
		ServiceUniteDuree serviceUniteDuree = new ServiceUniteDuree(); UniteDuree
		uniteDuree = serviceUniteDuree.findById(1); System.out.println(uniteDuree);
		System.out.println("Nom d'unite de duree : "+uniteDuree.getNomUniteDuree());
		
		System.out.println("****************");
		System.out.println("****************");
		
		ServiceTypePrepa serviceTypePrepa = new ServiceTypePrepa(); TypePrepa
		typePrepa = serviceTypePrepa.findById(1); System.out.println(typePrepa);
...
//		List<SePrepare> listeSePrepares = serviceSePrepare.findByIdSePrepare(1);
		...
		/*
		 * ServicePanier servicePanier = new ServicePanier(); Panier panier =
		 * servicePanier.findById(31); System.out.println(panier);
